...
export default function Landing() {
  ...
  return (
    <div>
      ...
      {/* Behind the scenes: the developer */}
      <section className="bg-brand-green-deep py-14 sm:py-20">
        <div className="container-page">
          <div className="mx-auto max-w-2xl text-center">
            <p className="eyebrow text-brand-gold">Behind the scenes</p>
            <h2 className="section-title mt-2 text-white">Meet the developer</h2>
            <p className="section-subtitle text-emerald-100/70">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-5">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 text-center lg:col-span-2">
              ...
              <h3 className="mt-4 text-lg font-bold text-white">{developer.name}</h3>
            ...
            <div className="space-y-6 lg:col-span-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-sm font-bold text-white">Selected projects</h4>
                </div>
