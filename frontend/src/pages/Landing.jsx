  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-brand-green-deep">
        <div className="pointer-events-none absolute -left-24 -top-24 h-80 w-80 rounded-full bg-brand-green-dark/50 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-24 -right-24 h-96 w-96 rounded-full bg-brand-green/40 blur-3xl" />
        <div className="pointer-events-none absolute right-1/3 top-1/4 h-40 w-40 rounded-full bg-brand-gold/10 blur-3xl" />
